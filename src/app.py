...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for students interested in high-level play",
    ...
    "Music Ensemble": {
        "description": "Join our orchestra and learn to play various musical instruments",
